        ...
        <div className="grid gap-10 pb-20 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
              ...
              <h3 className="text-2xl font-bold md:text-xl">YouTube</h3>
            </div>
          ...
          <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
              ...
              <h3 className="text-2xl font-bold md:text-xl">Instagram</h3>
            </div>
            <p className="text-gray-700">
          ...
          <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
              ...
              <h3 className="text-2xl font-bold md:text-xl">Twitter</h3>
            </div>
            <p className="text-gray-700">
          ...
          <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
              ...
              <h3 className="text-2xl font-bold md:text-xl">Facebook</h3>
            </div>
            <p className="text-gray-700">
          ...
          <div className="rounded-md border border-gray-200 bg-white p-8 shadow-sm">
            <div className="my-4 flex items-center">
              ...
              <h3 className="text-2xl font-bold md:text-xl">LinkedIn</h3>
            </div>
            <p className="text-gray-700">
