...
const Contact = () => {
  ...
  // Handle focus event for the phone input
  const handleFocus = () => {
    setIsFocused(true);
  };
  ...
  return (
    <>
      <div className="sm:p-10 my-auto mt-16 ">
        <section className="mx-auto py-2">
          <div className="mx-auto flex w-full flex-col items-center justify-center sm:max-w-screen-sm md:max-w-screen-md lg:flex-row">
            <div className="text-center">
              <h2 className="bg-clip-text text-3xl font-extrabold text-gray-700 sm:text-5xl mb-5">
        ...
        <section className="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 text-gray-800">
            <div className="order-last lg:order-first col-span-1 px-8 py-10 max-w-screen-md md:px-10 md:py-12">
              <h2 className="mb-8 text-2xl font-black">Get in touch</h2>
              <p className="mt-2 mb-4 font-sans text-sm tracking-normal">
                Please share few details so that the right sales specialist can
              ...
              <form action="">
                <div className="mb-5 relative">
                  ...
                  <input
                    className="w-full pl-10 border-b py-3 text-sm outline-none focus:border-b-2 focus:border-black"
                    type="text"
                ...
                <div className="mb-5 relative">
                  ...
                  <FaInfoCircle
                    ...
                    title="Best mobile number to reach you"
                    onClick={toggleTooltip}
                  />
                  {showTooltip && (
                    <div className="absolute right-12 top-1/2 transform -translate-y-1/2 bg-gray-700 text-white text-sm rounded py-1 px-2">
            ...
            <div className="col-span-1 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-1 md:border-r md:px-10 md:py-12 lg:col-span-1">
